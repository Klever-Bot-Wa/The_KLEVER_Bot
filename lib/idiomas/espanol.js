...
const smsModP2 = () => { return `تمكين الوظيفة حتى يتمكن الجميع من استخدام كليڤر بوت`}
const smsModAd1 = () => { return `🛂 وضع المشرف`}
const smsModAd2 = () => { return `سيتمكن المسؤولون فقط من استخدام كليڤر بوت في المجموعات`}
